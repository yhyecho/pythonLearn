...
# 你可以猜到，这种key-value存储方式，在放进去的时候，必须根据key算出value的存放位置，
...
d2 = {'yu': 1, 'ai': 2, 'zhang': 3}
print('Meng' in d2)
d2['Meng'] = 3
print('Meng' in d2)
print(d2)

print(d2.get('Meng2')) #二是通过dict提供的get方法，如果key不存在，可以返回None，或者自己指定的value：
print(d2.get('Meng3', -1))
