...
# 现在，如果我们要计算x的3次方怎么办？
# 可以把power(x)修改为power(x, n)，用来计算x的n次方，说干就干：
def power(x, n):
    s = 1
    while n > 0:
        n = n - 1
...
enroll('huayang', 'H')
print('============')
enroll('huayang2', 'test', 77, city='Nanjing')
...
print(add_end([1, 2, 3]))
print(add_end(['x', 'y', 'z'])) 
# 2) 当你使用默认参数调用时，一开始结果也是对的：   
print(add_end())
# 3) 但是，再次调用add_end()时，结果就不对了：
print(add_end())
print(add_end())
...
print(person3('Jack', 24, city='Beijing', job='Engineer'))
